          ...
          <div style={{ backgroundColor: 'white', position: "center", padding: '200px' }}>
            <div className="container" style={{ backgroundColor: '#91BB7F', padding: '20px' }}>
              <div className="row justify-content-between" style={{ padding: "20px" }}>
                ...
                <div >
                  <div>
                    <h3 className="display-4" >{isAuth ? isAuth.diplayName : "username"}</h3>
                  </div>
            ...
            <div>
              <Modal show={this.state.modal} onHide={()=>{this.setState({modal:!this.state.modal})}}>
                <Form >
                  <input id="oldPassword" type="text" onChange={this.handleChange}></input>
                </Form>
                <Form >
